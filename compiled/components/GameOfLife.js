...
var GameOfLife = function (_React$Component) {
  ...
  _createClass(GameOfLife, [{
    ...
    value: function renderCells() {
      ...
      var grid = this.props.store.getState().cells.map(function (element, index) {
        return _react2.default.createElement(_Cell2.default, { store: _this2.props.store, key: index, index: index, alive: element });
      });
      console.log(grid);
      return grid;
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'board-component', style: { width: '576px' } },
          this.renderCells()
        ),
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick() {
                return _this3.onImportSeed('GLIDER');
              } },
            'glider'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this3.onImportSeed('GLIDER_GUN');
              } },
            'glider gun'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this3.onImportSeed('ACORN');
              } },
            'acorn'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this3.onImportSeed('LINE');
              } },
            'line'
          ),
          _react2.default.createElement(
